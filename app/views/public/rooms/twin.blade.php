    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8 middle_right">
                <img src="../images/twin2.JPG" class="img-responsive" alt=""/>
            </div>
            <div class="col-md-4 middle_right well">
                ...
                two single beds,Tv,fridge, complimentary wired & Wi-Fi high speed internet.
                <hr/>
                <h4>Summary</h4>

                <ul id="general-info">
                    <li><i class="fa fa-male"> </i> Maxmum Person:<b> 2</b></li>
                    <li><i class="fa fa-circle-o"> </i> Two single beds </li>
